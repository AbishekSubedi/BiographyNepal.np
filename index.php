...
<body>
    ...
    <div id="main">
        <div>
            <center><h1>Some Important & Famous Figures</h1></center>
            <p>Hello. Welcome to my website. In this website you can learn about many famous persons and be motivated by reading their biography. Please fill free to leave comments if you like me to add your favorite persons. Thank you! Please enjoy your time reading. In the future I will also add other persons from every field.</p><br><br><hr><hr><br><br>
        </div>
    <div class="main-container">
        <div class="cards-container">    
            <div class="container1">
                <center><h3>1. Abraham Lincoln</h3>
            ...
            <div class="container2">
                <center><h3>2. Albert Einstein</h3>
            ...
            <div class="container3">
                <center><h3>3. Charles Babbage</h3>
            ...
            <div class="container2">
                <center><h3>5. Isaac Newton</h3>
                <a href="Isaac Newton.html"><img src="Isaac1.jpeg" alt="Isaac Newton" width="500px"></a></center>
